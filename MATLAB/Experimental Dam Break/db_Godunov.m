...
%   
%   Os testes suportados por esse programa são: Escoamentos subcritico, 
...
%malha
xmin = -4.65; xmax = 4.35; m = 900; 

%dados do problema
b   = 0.3; hu   = 0.25; hd = 0.10; vu = 0; vd = 0;
dam = 0;   n    = 0.005;

T = 8.9; t = 0; tmax = T/sqrt(g/hu); I = linspace(2,m-1,m-2);
